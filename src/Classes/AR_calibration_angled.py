...
class ARCalibration:
    ...
    def __init__(self, rate=30):
        ...
        self.calib_points = np.array([[0.5, 2.5], [-0.5, 2.5], [-0.5, 3.5], [0.5, 3.5]])
        # Offset values to match the virtual and the real robot positions
        self.offset_x = 0.0 # default: 0.05
        self.offset_y = 0.0
        # Scale value to match the virtual and the real workspace
        self.pose_scale_x = 2.0 #default: 2.12
        self.pose_scale_y = 2.0 #default: 2
        self.pose_scale_z = 1.0 #default:1.03
        # Proxy pose holder
