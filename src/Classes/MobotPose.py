...
class MobotPose:
    ...
    def __init__(self, rate=100):
        ...
        self.lin_pos_integrator = Integrator(self.global_vel)
        self.dt = 0.01

        self.sub = rospy.Subscriber("/sim/mobot_vel", Vector3, self.callback, queue_size=1)
        self.pub = rospy.Publisher("/sim/mobot_pose", Pose, queue_size=1)
    ...
    def update_ang_pos(self, ang_vel):
        self.pose_now.z = self.ang_pos_integrator.update(ang_vel, self.dt)
    ...
    def update_pos(self):
        ...
        self.pose_pub.position.x = global_pos[0]
        self.pose_pub.position.y = global_pos[1]
